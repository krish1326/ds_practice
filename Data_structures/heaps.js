 ...
 *
 * Big O notation of Binary Heap: 
 * 
 * a.For insertion/Removal:
 * 
 * The time complexity of Binary Heap is log N to the base 2 as we perform a operation,
 * we interact with each level once so number of operations is the same as the number
 * of levels of the tree.
 * 
 *  b. For searching:
 * It's order of n in the worst case, It is not mainly meant for searching because it is 
 * not maintained in such a way to leave a part of tree.
 */
class MaxBinaryHeap {
    constructor() {
        this.values = [];
...
test_max_binary_heap.insert(76);
test_max_binary_heap.insert(176);
test_max_binary_heap.insert(45);
test_max_binary_heap.insert(99);
test_max_binary_heap.insert(78);
